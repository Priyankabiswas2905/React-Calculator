...
function CalculatorDisplay(props) {
  ...
  console.log("precisionWithFraction", precisionWithFraction);
          ...
          <div className="input-keys">
            <div className="function-keys">
              ...
              <button
                id="key-divide"
                value="/"
                className=" key-divide operation-keys"
                onClick={this.handleClick}
              >
                &divide;
              </button>
            ...
            <div className="digit-keys">
              ...
              <button
                id="key-equals"
                value="="
                className=" key-equals operation-keys"
                onClick={this.handleClick}
              >
                =
              </button>
              ...
              <button
                id="key-add"
                value="+"
                className=" key-add operation-keys"
                onClick={this.handleClick}
              >
                +
              </button>
              ...
              <button
                id="key-subtract"
                value="-"
                className=" key-subtract operation-keys"
                onClick={this.handleClick}
              >
                &ndash;
              </button>
              ...
              <button
                id="key-multiply"
                value="*"
                className="key-multiply operation-keys"
                onClick={this.handleClick}
              >
                &times;
              </button>
